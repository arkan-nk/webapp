...
public class ListStorage extends AbstractStorage {
    ...
    protected void doUpdate(Resume r) throws ResumeStorageException {
        if (!storageList.contains(r)) throw new ResumeStorageException(r.getUuid(), "Resume " + r.getUuid() + " not found");
    ...
    protected Collection<Resume> getResumeCollection() {
        ...
        Arrays.sort(resumeArray, new Comparator<Resume>() {
            @Override
    ...
    private int indexInStorage(String uuid) throws ResumeStorageException {
        int index = Collections.binarySearch(storageList, new Resume(uuid, "", null), new Comparator<Resume>() {
            @Override
            public int compare(Resume o1, Resume o2) {
                return o1.getUuid().compareTo(o2.getUuid());
            }
